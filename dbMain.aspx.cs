...
namespace DbMgmAdmin
{
    ...
    {
      //  protected System.Web.UI.WebControls.Label lbltables;
      //  protected System.Web.UI.WebControls.Label lblHeader;
        ...
        private void ExecSQL()
        {
            ...
            if (Request.Form["sql"] == null)
            {
                ...
                lbltables.Text = lbltables.Text + "'Create the table (starting with 'TEST_'and Add the autonumber ID field as the primary key\n";
                lbltables.Text = lbltables.Text + "Create Table TEST_MyTABLENAME ([ID] INTEGER PRIMARY KEY IDENTITY)\n\n";
                lbltables.Text = lbltables.Text + "'Add 6 other fields with data type\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add Firstname varChar(255)\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add Lastname varChar(255)\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add City varChar(255)\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add State varChar(255)\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add Country varChar(255)\n";
                lbltables.Text = lbltables.Text + "Alter table TEST_MyTABLENAME Add Age Integer\n</TEXTAREA></td></tr>";
        ...
        private void AddTable()
        {
            ...
            lbltables.Text = lbltables.Text + "<TD><font size=1 face=arial color=red>*</font> <font size=1 face=arial color=black>Starting with 'TEST'</font><br><INPUT TYPE='text' NAME='tablename' SIZE='30' VALUE='TESTMyTable1'></TD>";
            lbltables.Text = lbltables.Text + "</TR>";
            lbltables.Text = lbltables.Text + "<TR><TD>&nbsp;</TD>";
