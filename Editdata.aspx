<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editdata.aspx.cs" Inherits="DbMgmAdmin.Editdata" %>
						...
						<TABLE id="Table1" height="407" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff"
							...
							<tr>
								...
								<td vAlign="top" align="center">
									<form id="frmViewState" action="EditData.aspx" method="post" enctype="multipart/form-data" runat="server">
											...
											<TR vAlign="top">
												...
												<TD valign="middle">
													<asp:Button id="Button1" runat="server" Text="<- Back to List"></asp:Button><asp:Label id="lblstatus" runat="server" Font-Size="Smaller" ForeColor="#004000" Font-Names="Verdana"
														Font-Bold="True">&nbsp;</t>EDIT RECORD: Ready for update</asp:Label><br>
													<br>
												</TD>
											</TR>
											<TR vAlign="top">
